    ...
    <Box sx={{ width: 300, height: '100%', display: 'flex', flexDirection: 'column', bgcolor: 'rgba(10,16,46,0.95)', backdropFilter: 'blur(20px)' }} role="presentation">
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', px: 2.5, py: 2, borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        <Stack direction="row" alignItems="center" spacing={1} onClick={() => { navigate("/"); setMobileOpen(false); }} sx={{ cursor: 'pointer' }}>
          <SLLogo sx={{ height: 100, width: 100 }} />
        ...
        {!isHome && (
          <ListItem disablePadding>
            <ListItemButton onClick={() => { navigate("/"); setMobileOpen(false); }} sx={{ px: 2.5, py: 1.5 }}>
              <ListItemText primary="← Home" primaryTypographyProps={{ fontFamily: oswald, fontWeight: 600, fontSize: '1rem', color: '#f68914', letterSpacing: '0.04em' }} />
            </ListItemButton>
          </ListItem>
        )}
      ...
      <Box sx={{ borderTop: '1px solid rgba(255,255,255,0.06)', p: 2.5 }}>
        {isAuthenticated ? (
          <Stack spacing={1.5}>
            <Button fullWidth variant="contained" onClick={handleDashboardClick} sx={{ fontFamily: oswald, fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase', borderRadius: '10px', py: 1.2, background: '#f68914', color: '#1a1206', boxShadow: '0 4px 14px rgba(246,137,20,0.30)' }}>Dashboard</Button>
          ...
          <Stack spacing={1.5}>
            <Button fullWidth variant="contained" onClick={() => { navigate("/login"); setMobileOpen(false); }} sx={{ fontFamily: oswald, fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase', borderRadius: '10px', py: 1.2, background: '#f68914', color: '#1a1206', boxShadow: '0 4px 14px rgba(246,137,20,0.30)' }}>Login</Button>
            ...
            <Toolbar disableGutters sx={{ justifyContent: "space-between", height: 70 }}>
              ...
              <Box sx={{ display: { xs: "none", md: "flex" }, alignItems: 'center', gap: 0.5 }}>
                {isHome ? (
                  ...
                  <Button onClick={() => navigate("/")} sx={{ fontFamily: oswald, color: "#f68914", fontWeight: 600, fontSize: '0.95rem', letterSpacing: '0.05em', textTransform: 'uppercase', borderRadius: '8px', px: 2, '&:hover': { bgcolor: 'rgba(246,137,20,0.06)' } }}>
                    ← Home
                  </Button>
                )}
                ...
                {isAuthenticated ? (
                  <>
                    <Button variant="outlined" onClick={handleDashboardClick} sx={{ fontFamily: oswald, fontWeight: 600, fontSize: '0.9rem', letterSpacing: '0.05em', textTransform: 'uppercase', borderRadius: '8px', borderColor: 'rgba(246,137,20,0.30)', color: '#ffce9e', px: 2.5, '&:hover': { borderColor: '#ffb054', bgcolor: 'rgba(246,137,20,0.06)' } }}>
                      Dashboard
                    </Button>
                  ...
                  <>
                    ...
                    <Button variant="contained" onClick={() => navigate("/public/register")} sx={{ fontFamily: oswald, fontWeight: 600, fontSize: '0.9rem', letterSpacing: '0.05em', textTransform: 'uppercase', borderRadius: '10px', px: 3, background: '#f68914', color: '#1a1206', boxShadow: '0 2px 10px rgba(246,137,20,0.30)', '&:hover': { boxShadow: '0 4px 16px rgba(246,137,20,0.45)', transform: 'translateY(-1px)' }, transition: 'all 0.2s ease' }}>
                      Get Started
                    </Button>
                  </>
                )}
