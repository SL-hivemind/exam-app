...
import {
  ...
  InputAdornment, Toolbar, CircularProgress,
} from '@mui/material';
...
export default function PortalLogin() {
  ...
  useEffect(() => {
    if (user && user.role === 'public_user') navigate('/portal/dashboard', { replace: true });
  }, [user, navigate]);
  ...
  return (
    <Box sx={{
      ...
      <Toolbar />
      <Box sx={{ width: '100%', maxWidth: 420, mt: { xs: 3, md: 8 }, px: 2 }}>
        <Box
        ...
        >
          ...
          <Box sx={{ mb: 2 }}>
            <Typography component="label" htmlFor="portal-email" sx={{
              fontFamily: ff, fontSize: '0.82rem', fontWeight: 600, color: '#c7d2fe', display: 'block', mb: 0.8,
            }}>Email</Typography>
            <TextField id="portal-email" fullWidth placeholder="your@email.com" type="email"
              value={email} onChange={e => setEmail(e.target.value)} required size="small" sx={inputSx} />
          </Box>

          <Box sx={{ mb: 1 }}>
            <Typography component="label" htmlFor="portal-pw" sx={{
              fontFamily: ff, fontSize: '0.82rem', fontWeight: 600, color: '#c7d2fe', display: 'block', mb: 0.8,
            }}>Password</Typography>
            <TextField id="portal-pw" fullWidth placeholder="••••••••" type={showPw ? 'text' : 'password'}
          ...
          <Box sx={{ textAlign: 'right', mt: 0.5 }}>
            <RouterLink to="/portal/forgot-password" style={{ textDecoration: 'none' }}>
          ...
          <Box sx={{ mt: 3, textAlign: 'center' }}>
            <Typography sx={{ fontFamily: ff, fontSize: '0.82rem', color: '#aeb9e0' }}>
              ...
              <RouterLink to="/portal/register" style={{ color: '#9fc1ff', fontWeight: 600, textDecoration: 'none' }}>
                Create one
              </RouterLink>
            </Typography>
          </Box>
